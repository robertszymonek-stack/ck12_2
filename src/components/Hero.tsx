...
export default function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative overflow-hidden bg-slate-950 pb-10 pt-8 text-white sm:pb-14 sm:pt-12 lg:pb-16 lg:pt-20"
    >
      {/* tło dekoracyjne */}
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-5 lg:px-8">
        ...
        <h1 className="text-[1.75rem] font-black leading-[1.1] tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
          Montaż klimatyzacji
        ...
        <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-white/70 sm:mt-5 sm:text-base lg:text-lg">
        ...
        <div className="mx-auto mt-6 max-w-xl sm:mt-8">
          {status === "sent" ? (
            ...
            >
              ...
              <div className="grid gap-2.5 sm:grid-cols-[1fr_1fr_auto] sm:gap-3">
                <input
                  required
                  value={form.name}
        ...
        <div className="mt-6 flex flex-wrap justify-center items-center gap-x-4 gap-y-2 text-xs text-white/55 sm:mt-8 sm:gap-x-6 sm:gap-y-3 sm:text-sm">
